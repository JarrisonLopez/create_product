...
class Create_product:
    ...
    def start_create_product(self):
        ...
        create_product.create_window()
        create_product.create_canvas()
        create_product.button_back_create_product()
        create_product.button_create_product()
        ...
        create_product.code()
        create_product.logo()
        create_product.start_window()


ventana = Create_product()
